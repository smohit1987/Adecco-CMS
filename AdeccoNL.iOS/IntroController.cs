...
namespace AdeccoNL.iOS
{
	partial class IntroController : BaseController
	{
		...
		private void LoadAppConfiguration()
		{
			...
			{
				// set default value
				userPref.SetString(defaultCountry, "defaultCountry");
				userPref.SetString(defaultLanguage, "defaultLanguage");
				userPref.SetString(defaultRegion, "defaultRegion");
			...
			else
			{
				// pick saved settings 
				 ...
				 defaultCountry	 = userPref.StringForKey("defaultCountry");
				 defaultLanguage = userPref.StringForKey("defaultLanguage");
				 defaultRegion =   userPref.StringForKey("defaultRegion");
			...
			Constants.setOfflineConfigs(defaultCountry, defaultRegion.ToString());
			// set application configuration setting 
			ConfigManager.readAppConfigurationSettings();
